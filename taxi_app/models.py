...
class DriverUser(models.Model):
	...
	photo_car = models.OneToOneField(Document, blank=True, null = True, related_name="photo_car" )
	photo_driver_license = models.OneToOneField(Document, blank=True, null = True, related_name="photo_driver_license")
	photo_car_license = models.OneToOneField(Document, blank=True, null = True, related_name="photo_car_license")
	...
	coefficient_congestion = models.FloatField(default = 1, blank = True, null = True)
...
class ClientUser(models.Model):
	...
	photo = models.OneToOneField(Document, blank=True, null= True)
	date_registration = models.DateTimeField(auto_now_add=True)
